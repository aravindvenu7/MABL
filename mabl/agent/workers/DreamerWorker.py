...
class DreamerWorker:
    ...
    def __init__(self, idx, env_config, controller_config):
        ...
        #print("STATE DIM, OBS DIM", self.state_dim, self.in_dim)
    ...
    def _select_actions(self, state, model, actor):
        avail_actions = []
        observations = []
        fakes = []
        ...
        actions = self.controller.step(observations, av_action, nn_mask, model, actor)
